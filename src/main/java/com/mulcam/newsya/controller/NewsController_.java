...
public class NewsController_ {
    ...
    public String getCategoryNews(@PathVariable("category") String category,
        ...
        if(category.equals("all")) {
            categoryNews = boardService.getLimitedBoards(offset, pageSize);
        } else {
            categoryNews = boardService.getLimitedNewsByCategory(category, offset, pageSize);
        }
