...
public interface SearchMapper {
    ...
    @Select(" SELECT * FROM news WHERE TITLE LIKE CONCAT('%', #{keyWord}, '%') AND CONTENT LIKE CONCAT('%', #{keyWord}, '%') ORDER BY DATE DESC LIMIT #{offset}, #{limit} ")
    List<SearchDto> searchKeyWord(@Param("keyWord") String keyWord, @Param("offset") int offset, @Param("limit") int limit);
